...
class TestUtils(unittest.TestCase):
    ...
    def testCBDThreeDatesTrue(self):
        ...
        self.assertTrue(check_between_dates(self.start, self.end, self.startWorked))

    def testCBDFourDatesTrue(self):
        """- Test Check Between Dates: Four Dates True"""
        """ Expect True if two datetimes are between start - end """
        self.assertTrue(
            check_between_dates(self.start, self.end, self.startWorked, self.endWorked)
        )
